...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="user.php?halaman=stok-bcoklatu">Bubuk Coklat</a>
          </div>
        </div>
      </li>
       <!-- Divider -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsehitung" aria-expanded="true" aria-controls="collapseUtilities">
          <i class="fas fa-fw fa-cloud"></i>
          <span>Hitung Ramalan</span>
        </a>
        <div id="collapsehitung" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Hitung peramalan:</h6>
            <a class="collapse-item" href="user.php?halaman=hitung-bcoklat">Bubuk Coklat</a>
          </div>
        </div>
      </li>
	...
	<!-- Divider -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseldataramal" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="user.php?halaman=data-ramalbcoklatu"> Data Ramal Bubuk Coklat</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseldataorder2020" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="user.php?halaman=stok-bcoklatu2020">Bubuk Coklat</a>
          </div>
        </div>
      </li>
      ...
      <hr class="sidebar-divider">
       ...
       <li class="nav-item">
        <a class="nav-link" href="user.php?halaman=reportu">
        ...
        <div class="container-fluid">
         ...
         <?php
                    ...
                    if ($_GET['halaman']=="admin")
                    {
                        ...
                        elseif ($_GET['halaman']=="stok-bcoklatu")
                    {
                        include 'stok-bcoklatu.php';
                    }
                        ...
                        elseif ($_GET['halaman']=="tes")
                    {
                        ...
                        elseif ($_GET['halaman']=="stok-bcoklatu2020")
                    {
                        include 'stok-bcoklatu2020.php';
                    }
                        elseif ($_GET['halaman']=="lapor-ramalbcoklat")
                    {
                        include 'lapor-ramalbcoklat.php';
                    }
                        elseif ($_GET['halaman']=="data-ramalbcoklatu")
                    {
                        include 'data-ramalbcoklatu.php';
                    }
                        elseif ($_GET['halaman']=="logout")
                    {
                        include 'logout.php';
                    }
                        elseif ($_GET['halaman']=="lapor")
                    {
                        include 'hapuspelanggan.php';
                    }
                        elseif ($_GET['halaman']=="reportu")
                    {
                        include 'reportu.php';
                    }
                    }           
